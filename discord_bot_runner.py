#!/usr/bin/env python3
"""
Clean standalone Discord bot runner with no web components.
This script is designed to be used in the run_discord_bot workflow.
"""
import os
import sys
import logging
...
logger.info("Starting Discord bot in standalone workflow mode")
print("Starting Discord bot in standalone workflow mode")
...
# Define the AI service for Gemini
